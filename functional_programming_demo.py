...
# print_name("Shivshankar","Gadeodhe")    
...
# my_class.print_name_oops("Shivshankar","Gadeodhe", 'Mr')        
...
# print_name_FS(print_name,"Shivshankar","Gadeodhe",'Mr')
...
# print(
# sorted( ['shivshankar','gadeodhe','mr'],key = my_custom_sort_val,reverse= False ))
